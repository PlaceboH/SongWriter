...
@Component({
  ...
  export class CreateMusicWorkComponent implements OnInit {
    ...
    constructor(private dialogRef: MatDialogRef<CreateMusicWorkComponent>,
    ...
    submit(): void {
        this.musicWorkService.createMusicWork({
            ...
            if (this.createdMusicWork.id != null) {
                ...
                .subscribe(() => {
                    this.notificationService.showSuccessSnackBar('Music work created successfully');
